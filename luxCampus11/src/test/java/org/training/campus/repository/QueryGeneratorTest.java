...
class QueryGeneratorTest {
	...
	void testInsert() {
		...
		final String expected = """
				insert into person(
				ssn,firstname,lastname,birthDate,sex,height,weight,eyeColor
				) values (
				'0123456789','John','Smith','2000-01-01','MALE',180,80,'BLUE'
				);
				""";
	...
	void testGetById() {
		...
		final String actual = QueryGenerator.getInstance().getById(Person.class, 1);
		assertEquals(expected, actual);
	}
